...
```
1065 files -> 920 corpus -> 685 modelling sample
  ...
  (generated by src/build_current_results.py from the disposition flow in
   model/exposure_results.json, asserted at build time):
    1065 - 58 excluded - 74 skipped - 4 no development record - 2 in run-off - 7 no reserves = 920
  from the corpus to the working sample, also disjoint:
    920 - 147 net or unstated basis (106 net, 41 unstated; `data/pyd_basis_register.json`,
     `src/pyd_basis_rule.py`) - 9 unusable severity - 0 missing opening reserves
     - 79 without premium weights = 685
  132 of the 1065 filings carry no usable dual-model extraction. That is a diagnostic
...
Corpus:          920 syndicate-years / 133 syndicates; 37 appear in all 11 years (2014-2024)
Modelling sample: 685 syndicate-years / 120 syndicates
```

Coverage is **66 % of active syndicate-years overall** (685 of 1,040; it was ~47 % on the
...
|---|---:|---:|---:|
| Corpus | 919 | 920 | +1 |
| Net or unstated basis | 157 | 147 | -10 |
| Unusable severity | 9 | 9 | +0 |
| Missing premium weights | 75 | 79 | +4 |
...
was found**). The 920-observation dataset is **677 GBP / 243 USD (26%)**, with zero disagreement
