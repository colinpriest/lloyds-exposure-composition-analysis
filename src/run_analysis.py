...
def _gen_table32(results):
    ...
    content = (
        ...
        "comparator, which flags a numeric field at 0.5\\% of the larger and 0.05 absolute. "
        f"Of {dual} dual-model files, {disagree} exhibited material disagreement. "
        "Which reading this analysis carries forward is decided in the loader and not by this "
