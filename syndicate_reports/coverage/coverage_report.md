...
|   syndicate |   candidate_syndicate_years |   downloaded |   report_unavailable |   pyd_ok |   lob_ok |   opening_ok |   full_success |   fail_pyd |   fail_lob |   fail_opening |   no_mature_cohort_excl |   no_triangle_excl |   ritc_occurred |
|------------:|----------------------------:|-------------:|---------------------:|---------:|---------:|-------------:|---------------:|-----------:|-----------:|---------------:|------------------------:|-------------------:|----------------:|
